...
import { committee, facilities, site } from "@/lib/data";
import {
  educateursHistorique,
  histoireChapitres,
  histoireRemerciements,
  membresComiteHistorique,
} from "@/lib/histoire";
import {
  clubHouse,
  courtsExterieurs,
            ...
            <div className="mt-20 grid gap-8 lg:grid-cols-[1fr_1.1fr]">
              ...
              <div>
                <Accordion
                  ...
                  items={[
                    {
                      q: `Les membres du comité au fil des années (${membresComiteHistorique.length})`,
                      a: membresComiteHistorique.join(" · "),
                    },
                    {
                      q: `Les éducateurs et animateurs sportifs (${educateursHistorique.length})`,
                      a: educateursHistorique.join(" · "),
                    },
                  ]}
                />
              </div>
